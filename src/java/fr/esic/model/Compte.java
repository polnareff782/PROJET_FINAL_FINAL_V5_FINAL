...
public class Compte {
  ...
  private int montantEpargne;
    ...
    public Compte(String numcompte, String solde, String numcarte, boolean etatcarte, boolean opposition, String operation, Date date_expiration, String typeOperation, Date dateOperation, int montantDecouvert, String livretA, User user, Person person) {
        this.numcompte = numcompte;
        this.solde = solde;
        this.numcarte = numcarte;
        this.etatcarte = etatcarte;
    ...
    public void setLivretA(String livretA) {
        this.livretA = livretA;
    }
